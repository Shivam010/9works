        ...
        <Link href={href}>
            <a
                ...
                className={
                    ...
                    className +
                    ' p-6 rounded-md ' +
                    ' shadow-sm shadow-rang-700' +
                    ' text-rang-900 dark:text-rang-0 bg-rang-200 dark:bg-rang-800 ' +
                    ' hover:bg-gradient-to-tl hover:from-rang-200 hover:via-rang-300 hover:to-rang-200 hover:shadow-none ' +
                    ' hover:dark:bg-gradient-to-tl hover:dark:from-rang-800 hover:dark:via-rang-900 hover:dark:to-rang-800 '
                }
