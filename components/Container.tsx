...
export function Container({
    ...
    const meta = {
        title: "9works - Shivam's Tech Garage Workstation",
        description: `9works is the Tech Garage Workstation of Shivam Rathore (aka Shivam010), the work here is based on the tinkering and experiment on new technologies.`,
        image: 'https://9works.tk/images/banner.png',
        ogType: 'website',
        ...metadata,
    };
