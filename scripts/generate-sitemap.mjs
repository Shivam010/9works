...
const RoutesImagesInfo = {
    '/': [
        {
            loc: '/banner.png',
            title: "Welcome to 9works Shivam's Micro Space",
        },
        {
            loc: '/logo.png',
            title: '9works Logo',
    ...
    '/projects/concurrency': [
        {
            loc: '/images/concurrency/problem.png',
            title: 'One Gopher doing all the work',
        },
        {
            loc: '/images/concurrency/solution_with_concurrency.png',
            title: 'Multiple Gophers trying to complete one task at a time - Concurrency',
        },
    ],
};
...
async function generate() {
    ...
    pages.push('public/license', ...readDirectories('public/o'));
    console.log(pages);
